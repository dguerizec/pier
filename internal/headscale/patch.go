// Package headscale append-patches a headscale config.yaml to register a
// pier-managed TLD as a split-DNS domain. We only ADD entries; existing
// `dns:` keys, comments, and unrelated config (ACL, derp, log, ...) are
