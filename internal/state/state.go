...
// registry of repos pier knows about — populated by `pier init`, `pier up`,
// and the REST API. Workload rows alone cannot recover a moved or missing
// primary worktree reliably.
package state
